        ...
        <div class="glass-card p-12 rounded-3xl shadow-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
                <div class="md:col-span-1 pr-6 border-r border-gray-100 sticky top-32">
                    ...
                    <p id="guideDesc" class="text-gray-600 mb-8 leading-relaxed">png, jpg, jpeg, bmp docx, xlsx, pptx, txt 지원 (최대 50MB)</p>
...
HTML_FOOTER = """
    ...
    <script>
        ...
        btnSingle.onclick = () => {
            ...
            // 🕵️ 가이드 문구 50MB 반영
            guideDesc.textContent = "PNG, JPG, DOCX, XLSX, PPTX, HWP, TXT 지원 (최대 50MB)";
        };
...
# 최종 조립
HTML_CONTENT = HTML_HEADER + ABOUT_SECTION + API_SECTION + HTML_FOOTER# templates.py
from components import ABOUT_SECTION, API_SECTION
